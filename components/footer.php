...
<footer class="bg-primary border-t-4 border-tertiary text-white">
  <div class="container text-center pt-3 pb-4 flex flex-col lg:flex-row justify-between">
    <span>Hak cipta &copy; 2020 - <a href="<?= site_url() ?>"><?= $this->session->school_name ?></a>. <a href="https://github.com/dikisiswanto/barka" target="_blank" rel="noopener">Tema Barka</a> oleh <a href="https://silirdev.com" target="_blank" rel="noopener">silirdev</a></span>
